...
from integrasuite.custom_function.hr_custom_function import get_payroll_settings, get_salary_tax, get_month_details
import math
	...
	def update_salary_structure(self, new_basic_pay=0, remove_flag=1):
		...
		for ed in ['earnings', 'deductions']:
			...
			for ed_item in self.get(ed):
				...
				ed_item.amount = roundoff(flt(ed_item.amount))
